...
1. Spawn one child with `await rlm(prompt, name='comment-sicko')`, passing the Comment Sicko persona from `references/comment-sicko.md` verbatim plus the scope. Do not restate its rules.
