...
- `Read` tool calls against any `SKILL.md` file (project `.prime/agent/skills/`, user-level `~/.prime/agent/skills/`, or package-shipped paths (a `skills/` dir in an installed npm package, or built-ins under the prime-agent install))
